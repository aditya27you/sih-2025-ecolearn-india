...
- [ ] T001 Initialize Vite React-TS project (clean existing if needed) in .
- [ ] T002 [P] Install dependencies: React 19, TS 5, Vite 6, Tailwind 4, DaisyUI 5.5, React Router 7, Zustand 5 in package.json
